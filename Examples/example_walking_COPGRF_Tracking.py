...
for subject in subjects:
    for walking_trial in trials:
        ...
        grf_path = 'C:\\Users\\MoBL3\\Documents\\GRF_Project\\opencap-processing-grf\\Data\\GRF_tracking_data\\subject8walking3\\ForceData\\MoCapCOPx_ML_GRFs.mot'
        ...
        gait_style = "treadmill"  # Specify the gait style, e.g., treadmill or overground
        ...
        mask_ips, mask_cont, gait_events = process_gait_data(session_dir, name_trial, 'l', lowpass_cutoff_frequency, n_gait_cycles, gait_style, trimming_start, trimming_end)
        ...
        case = 'Mocap COPs case treadmill'  # Name case based on stiffness value
        settings['weights']['copMonotonicTerm'] = 0.1
        settings['weights']['copTrackingTerm'] = .1
        settings['weights']['grfTrackingTerm'] = 0.01
        settings['weights']['pelvisResidualsTerm'] = 0.0001
        settings['weights']['positionTrackingTerm'] = 100
        settings['weights']['filter_cops_toTrack'] = False
        settings['weights']['jointAccelerationTerm'] = 0 
        settings['weights']['activationTerm'] = 10
        settings['torque_driven_model']  =  False
