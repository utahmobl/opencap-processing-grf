...
for subject in subjects:
    for walking_trial in trials:
        ...
        # try:
                ...
                val_data_path = 'C:/MyDriveSym/mobilecap/Data/Data_paper/LabValidation_withoutVideos'
               ...
               #ik_path = os.path.join(path_to_data,  'walking' + walking_trial + '_ik.mot')
                ik_path = os.path.join(val_data_path,f"\\subject{subject}\\OpenSimData\\Mocap\\IK\\walking{walking_trial}.mot")
                
                #grf_path = os.path.join(path_to_data,  'Predicted_GRF.mot')
                grf_path = os.path.join(val_data_path,f"subject{subject}\\ForceData\\walking{walking_trial}_forces.mot")
                ...
                dataFolder = 'C:\\Users\\suhlr\\Downloads\\GRF_testing'
                ...
                session_dir = os.path.join(val_data_path,"subject" + subject) # Path to session data directory
                ...
                case = 'Mocap IK newFT IDWeights cop10 pos100 coordTrack v13' # Name case based on stiffness value
