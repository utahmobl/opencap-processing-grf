...
def get_setup(motion_type):
    ...
    setups['walking_periodic_grf_and_cop_tracking'] = {
         'ipopt_tolerance': 3,
         'weights': {
             'positionTrackingTerm': 1000,
             'velocityTrackingTerm': 100,
         ...
         'grfs_toTrack': {
             'all': {"weight": 10}}, 
         'CoP_times': {
             'right': {"begin": 1, "end" : 100},
             'left': {"begin": 1, "end" : 100}},
         'pelvisResiduals_toTrack': {
             'pelvis_tx': {"weight": 1},
             'pelvis_ty': {"weight": 1},
             'pelvis_tz': {"weight": 1},
    ...
    setups['walking_periodic_grf_and_cop_tracking_muscle_driven'] = {
         'ipopt_tolerance': 3,
         'weights': {
             'positionTrackingTerm': 1000,
             'velocityTrackingTerm': 100,
         ...
         'periodicConstraints': {
             ...
             'muscleActivationsForces': ['all'],
             'lumbarJointActivations': ['all']},
         'meshDensity': 100} # TODO RETURN TO 100
    
    setups['walking_NoNperiodic_ASB_formulation'] = {
        'ipopt_tolerance': 3,
        'weights': {
            'positionTrackingTerm': 1000,
            'velocityTrackingTerm': 100,
    ...
    setups['walking_NoNperiodic_ASB_COP'] = {
        'ipopt_tolerance': 3,
        'weights': {
            'positionTrackingTerm': 1000,
            'velocityTrackingTerm': 100,
