...
class kinematics:
    ...
    def __init__(self, sessionDir, trialName, 
        ...
        modelBasePath = os.path.join(sessionDir, 'EYM_GRF_Project', 'Rescaled_Models')
        # Load model if specified, otherwise load the one that was on server
        modelName = 'scaled_noArms_OC'
        ...
        searchTrialName = 'OC_results_' + trialName + '_ik'
        motionPath = os.path.join(sessionDir, 'EYM_GRF_Project', 'New_IK', 'Results',
                                  '{}.sto'.format(searchTrialName))
    ...
    def get_marker_dict(self, session_dir, trial_name, 
        ...
        searchTrialName_mrk = 'OpenCap_' + trial_name
        trcFilePath = os.path.join(session_dir,
                                   'EYM_GRF_Project', 'TRC_Files',
                                   '{}.trc'.format(searchTrialName_mrk))
